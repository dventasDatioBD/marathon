...
lazy val commonSettings = inConfig(SerialIntegrationTest)(Defaults.testTasks) ++
  ...
  // Tests run in parallel on a forked JVM by default.
  // This target does not run any integration tests.
  fork in Test:= true,
  ...
  // Tests tagged with @IntegrationTest run in parallel on a forked JVM.
  ...
  // Tests tagged with @SerialIntegrationTest run on a forked JVM but sequentially.
  ...
  // Run first @IntegrationTest tagged tests and then @SerialIntegrationTest
  // tagged tests.
